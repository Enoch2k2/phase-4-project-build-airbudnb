...
class DogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post dogs_url, params: { dog: { password_digest: @dog.password_digest, username: @dog.username } }, as: :json
    end
  ...
  test "should update dog" do
    patch dog_url(@dog), params: { dog: { password_digest: @dog.password_digest, username: @dog.username } }, as: :json
    assert_response 200
  end
