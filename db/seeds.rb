...
dogHouse404 = DogHouse.second
dogHouse500 = DogHouse.third

Trip.create(start_date: Date.today, end_date: Date.tomorrow, dog_house: dogHouse404, dog: spot404)
Trip.create(start_date: 3.days.from_now, end_date: 4.days.from_now, dog_house: dogHouse500, dog: spot404)